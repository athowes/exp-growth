...
archive_to_docs("sim_metagenomic-time-series")
archive_to_docs("fit_poisson-regression")
archive_to_docs("benchmark_poisson-regression")
archive_to_docs("explore_compartmental")
archive_to_docs("sim_airplane-time-series")
