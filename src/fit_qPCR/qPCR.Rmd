...
Plot below contains prior on counts $n$ (blue), simulated fluorescence (circles), and inferred counts (orange) based on the simulated data.

```{r}
knitr::include_graphics("n-prior-data-posterior.pdf")
```

# Stan code

```{stan, output.var="ex", code=readLines('4pl.stan')}
```
