...
We will now simulate and plot data for this model (lognormal geometric auto-regressive for the baseline, and lognormal geometric random walk for the exponential) with `r n_organism` organisms in total, each of which with `r n_kmer` $k$-mers as before.
